...
document.getElementById("smean1").value=Number((Math.sqrt(722*((myapp.score3/255)**2)+7152*((myapp.score2/255)**2)+2126*((myapp.score1/255)**2))).toFixed(1));
        myapp.pscore1=Number((document.getElementsByName("pscore1")[0].value).toFixed(1));
        myapp.pscore2=Number((document.getElementsByName("pscore2")[0].value).toFixed(1));
        myapp.pscore3=Number((document.getElementsByName("pscore3")[0].value).toFixed(1));
...
if((myapp.tscore==100)==false){
 document.getElementsByName("pscore1")[0].value=myapp.pscore1=(myapp.pscore1-(myapp.tscore-100)/(myapp.tscore/myapp.pscore1));
 document.getElementsByName("pscore2")[0].value=myapp.pscore2=(myapp.pscore2-(myapp.tscore-100)/(myapp.tscore/myapp.pscore2));
 document.getElementsByName("pscore3")[0].value=myapp.pscore3=(myapp.pscore3-(myapp.tscore-100)/(myapp.tscore/myapp.pscore3))};
};
