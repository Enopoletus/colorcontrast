...
document.getElementById("gmean3").value=10*Number((Math.sqrt(11.4*((myapp.score9/255)**2)+58.7*((myapp.score8/255)**2)+29.9*((myapp.score7/255)**2))).toFixed(1));
document.getElementById("gmean2").value=10*Number((Math.sqrt(11.4*((myapp.score6/255)**2)+58.7*((myapp.score5/255)**2)+29.9*((myapp.score4/255)**2))).toFixed(1));
document.getElementById("gmean1").value=10*Number((Math.sqrt(11.4*((myapp.score3/255)**2)+58.7*((myapp.score2/255)**2)+29.9*((myapp.score1/255)**2))).toFixed(1));
};
