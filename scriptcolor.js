...
document.getElementById("gmean3").value=Number(100*(Math.sqrt((.114*myapp.score9/255)**2+(.587*myapp.score8/255)**2+(.299*myapp.score7/255)**2)).toFixed(1));
document.getElementById("gmean2").value=Number(100*(Math.sqrt((.114*myapp.score6/255)**2+(.587*myapp.score5/255)**2+(.299*myapp.score4/255)**2)).toFixed(1));
document.getElementById("gmean1").value=Number(100*(Math.sqrt((.114*myapp.score3/255)**2+(.587*myapp.score2/255)**2+(.299*myapp.score1/255)**2)).toFixed(1));
};
