...
document.getElementById("count9").value=myapp.score9=parseInt(document.getElementsByName("score9")[0].value);
        //yeah I know
document.getElementById("count33").value=Number((Math.sqrt((myapp.score9/2.55)**2+(myapp.score8/1.23)**2+(myapp.score7/2.04)**2)/3).toFixed(1));
document.getElementById("count32").value=Number((Math.sqrt((myapp.score6/2.55)**2+(myapp.score5/1.23)**2+(myapp.score4/2.04)**2)/3).toFixed(1));
document.getElementById("count31").value=Number((Math.sqrt((myapp.score3/2.55)**2+(myapp.score2/1.23)**2+(myapp.score1/2.04)**2)/3).toFixed(1));
};
