...
document.getElementById("count33").innerHTML=(myapp.score9+myapp.score8+myapp.score7)/3;
document.getElementById("count32").innerHTML=(myapp.score6+myapp.score5+myapp.score4)/3;
document.getElementById("count31").innerHTML=(myapp.score3+myapp.score2+myapp.score1)/3;
};
