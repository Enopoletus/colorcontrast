...
if((myapp.tscore==100)==false){
 document.getElementsByName("pscore1")[0].value=myapp.pscore1=(myapp.pscore1/myapp.tscore);
 document.getElementsByName("pscore2")[0].value=myapp.pscore2=(myapp.pscore2/myapp.tscore);
 document.getElementsByName("pscore3")[0].value=myapp.pscore3=(myapp.pscore3/myapp.tscore)};
