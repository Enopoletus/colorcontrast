...
document.getElementById("pscore13").value=myapp.pscore3;};
        ...
        document.getElementById("tc1").value=Math.sqrt((myapp.ucount3-myapp.ucount1)**2+(p2)**2)/pytu;
        document.getElementById("tc2").value=Math.sqrt((myapp.ucount3-myapp.ucount2)**2+(p3)**2)/pytu;
        document.getElementById("tc3").value=Math.sqrt((myapp.ucount2-myapp.ucount1)**2+(p1)**2)/pytu;
        document.getElementById("tc1y").value=Math.sqrt((myapp.ucount3-myapp.ucount1)**2+(dyst2/y)**2)/pytu;
        document.getElementById("tc2y").value=Math.sqrt((myapp.ucount3-myapp.ucount2)**2+(dyst3/y)**2)/pytu;
        document.getElementById("tc3y").value=Math.sqrt((myapp.ucount2-myapp.ucount1)**2+(dyst1/y)**2)/pytu;
};
